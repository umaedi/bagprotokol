...
class GaleriController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        $data = [
            'title' => 'Galeri',
            'descTitle' => 'Seluruh foto foto galeri di aplikasi ' . env('APP_NAME'),
            'breadcrumb' => [
                ['url' => '/', 'name' => 'Home'],
    ...
    public function getCreate()
    {
        $data = [
            ...
            'descTitle' => 'Halaman ini berfungsi untuk menambahkan foto ke ' . env('APP_NAME'),
    ...
    public function getEdit($id)
    {
        $data = [
            ...
            'descTitle' => 'Halaman ini berfungsi untuk mengubah data foto galeri',
            'kategori' => KategoriGaleri::active()->get(),
            'breadcrumb' => [
                ['url' => '/', 'name' => 'Home'],
                ['url' => '/galeri', 'name' => 'Galeri'],
    ...
    public function getKategori()
    {
        ...
        $data = [
            ...
            'descTitle' => 'Seluruh kategori galeri di aplikasi ' . env('APP_NAME'),
            'breadcrumb' => [
                ['url' => '/', 'name' => 'Home'],
    ...
    public function createCategori()
    {
        $data = [
            ...
            'descTitle' => 'Halaman ini berfungsi untuk menambahkan kategori foto ke ' . env('APP_NAME'),
            'breadcrumb' => [
                ['url' => '/', 'name' => 'Home'],
                ['url' => '/galeri', 'name' => 'Galeri'],
    ...
    public function editCategori($id)
    {
        $data = [
            ...
            'descTitle' => 'Halaman ini berfungsi untuk mengubah data kategori galeri',
            'breadcrumb' => [
                ['url' => '/', 'name' => 'Home'],
