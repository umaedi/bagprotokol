...
class UserController extends Controller
{
    ...
    public function getIndex() {
        ...
        $data = [
            'title' => 'List Pengguna',
            'descTitle' => 'Seluruh pengguna aplikasi '. env('APP_NAME'),
            'breadcrumb' => [
                ['url' => '/' , 'name' => 'Home'],
    ...
    public function getCreate() {
        $data = [
            ...
            'descTitle' => 'Halaman ini berfungsi untuk menambahkan pengguna ke '. env('APP_NAME'),
            'breadcrumb' => [
                ['url' => '/' , 'name' => 'Home'],
...
//            throw $th;
    ...
    public function getEdit($id) {
        $data = [
            'title' => 'Edit Pengguna',
            'descTitle' => 'Halaman ini berfungsi untuk mengubah data pengguna',
            'breadcrumb' => [
                ['url' => '/' , 'name' => 'Home'],
                ['url' => '/users' , 'name' => 'Pengguna'],
