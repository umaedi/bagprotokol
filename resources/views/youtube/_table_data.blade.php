<table class="table card-table table-vcenter text-nowrap datatable">
    ...
    @forelse($table as $key => $tb)
        <tr>
            ...
            <td><a href="{{ url('youtube/edit/'.$tb->id) }}" class="text-reset" tabindex="-1">{{ $tb->title }}</a></td>
            ...
            <td class="text-end">
                            <span class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ url('youtube/edit/'.$tb->id) }}">
            ...
            <td colspan="8" class="text-center">
                <div class="empty">
                    ...
                    <div class="empty-action">
                        <a href="{{ url('youtube/create') }}" class="btn btn-primary">
