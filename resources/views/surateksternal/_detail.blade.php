    ...
    <div class="col-md-12 mb-1">
        <div class="card">
            ...
            <div class="card-header">
                <h4 class="card-title">Informasi Surat Nomor {{ $surat->eks_nosurat }}</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="row mb-2">
                            ...
                            <div class="col font-weight-bold">{{ \Carbon\Carbon::parse($surat->eks_tgl_surat)->isoFormat('dddd, D/MMMM/YYYY') }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold">{{ \Carbon\Carbon::parse($surat->eks_tgl_kirim)->isoFormat('dddd, D/MMMM/YYYY') }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold">
                                @if($surat->eks_id_opd != null)
                                    {{ $surat->pengirim->nama_opd }}
                                @else
                                {{ $surat->eks_dari }}
                                    @endif
                            </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_pengirim }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_tertanda }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_teruskan }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_status }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_karakteristik }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_derajat }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_perihal }}</div>
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col font-weight-bold"> {{ $surat->eks_isi }}</div>
                        </div>

                    </div>

                    <div class="col-md-3 text-center">
                        <div class="hr-text hr-text-left mb-1 mt-1">Lampiran</div>
                        ...
                        <br>
                        <a target="_blank" href="{{ \Illuminate\Support\Facades\Storage::url($surat->eks_file_lampiran) }}">Berkas Surat: {{ $surat->eks_nosurat }}</a>
                        <div class="hr-text hr-text-left mt-3 mb-2">QR Code</div>
                        <a href="{{ \Illuminate\Support\Facades\Storage::url($surat->eks_qrcode) }}" class="image-link">
                            <img src="{{ \Illuminate\Support\Facades\Storage::url($surat->eks_qrcode) }}" class="avatar avatar-2xl">
                        </a>
                    </div>
                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @if($o->dis_tgl_terima != null)
                                                        ...
                                                        @if(in_array(auth()->user()->level, [env('role_superadmin'), env('role_admin'), env('role_surat')]))
                                                            <a href="{{ url('/surat/disposisi/'. \Vinkla\Hashids\Facades\Hashids::encode($surat->eks_id). '/eksternal/' . \Vinkla\Hashids\Facades\Hashids::encode($o->dis_id)) }}" class="btn btn-primary">
