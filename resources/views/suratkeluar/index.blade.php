...
@section('content')
    <div class="container-xl">
        ...
        <div class="form-group row mt-2 text-end">
            <div class="col">
                <input class="form-check-input m-0 align-middle" onchange="checkAll()" id="checkAll" type="checkbox" aria-label="Pilih semua data"> <b>Check Semua</b>
            </div>
        </div>
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return new Promise(async function (resolve) {
                        var param = {
                            method: 'POST',
                            url: '{{ url('surat/keluar/bulk-delete') }}',
                            data: {
                                '_method': 'POST',
                                'ids': tableCheck
                            }
