        ...
        <div class="btn-list">
            ...
            <button onclick="terima('{{ $disID}}')" class="btn btn-info d-none d-sm-inline-block">
                ...
                @endif
                    ...
                    @if(!$btnTerima)
            <a href="{{ url('/surat/disposisi/'. \Vinkla\Hashids\Facades\Hashids::encode($surat->id_qr). '/surat/' . \Vinkla\Hashids\Facades\Hashids::encode($disID)) }}" class="btn btn-primary d-none d-sm-inline-block">
                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
            ...
            <button onclick="terima('{{ $disID }}')"  class="btn btn-info d-sm-none btn-icon">
                ...
                @endif
                    ...
                    @if(!$btnTerima)
            <a href="{{ url('/surat/disposisi/'. \Vinkla\Hashids\Facades\Hashids::encode($surat->id_qr) . '/surat/' . \Vinkla\Hashids\Facades\Hashids::encode($disID)) }}"  class="btn btn-primary d-sm-none btn-icon">
                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrows-left-right" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <line x1="21" y1="17" x2="3" y2="17" />
