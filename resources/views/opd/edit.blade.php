    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form action="{{ url('opd/'.$edit->id_opd) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <input type="text" name="nama_opd" id="nama_opd" value="{{ old('nama_opd', $edit->nama_opd) }}" class="form-control @error('nama_opd') is-invalid @enderror" placeholder="Masukkan nama organisasi..">
                                @error('nama_opd')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <input type="text" name="alias_opd" id="nama_opd" value="{{ old('alias_opd', $edit->alias_opd) }}" class="form-control @error('alias_opd') is-invalid @enderror" placeholder="Masukkan nama alias organisasi..">
                                @error('alias_opd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <textarea name="alamat_opd" id="alamat_opd" class="form-control @error('alamat_opd', $edit->alamat_opd) is-invalid @enderror" placeholder="Masukkan alamat organisasi..">{{ old('alamat_opd', $edit->alamat_opd) }}</textarea>
                                @error('alamat_opd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <input type="email" name="email_opd" id="email_opd" value="{{ old('email_opd', $edit->email_opd) }}" class="form-control @error('email_opd') is-invalid @enderror" placeholder="Masukkan email..">
                                @error('email_opd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <input type="text" name="notelepon_opd" id="notelepon_opd" value="{{ old('notelepon_opd', $edit->notelepon_opd) }}" class="form-control @error('notelepon_opd') is-invalid @enderror" placeholder="Masukkan Nomor Telepon..">
                                @error('notelepon_opd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col">
                                <select name="pengguna" class="form-control select2 @error('pengguna') is-invalid @enderror" id="pengguna">
                                    <option></option>
                                    @if($edit->user && !old('pengguna'))
                                        <option value="{{ $edit->user->id }}" selected>{{ $edit->user->name }}</option>
                                    @endif
                        ...
                        <div class="hr-text hr-text-left">Status OPD</div>
