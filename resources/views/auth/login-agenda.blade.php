...
@push('css')
    <style>
        .login:before {
            background-image: url("{{ asset('themes-login/images/bg-login-agenda.svg') }}");
        }
    </style>
@endpush
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    <span class="text-white text-lg ml-3"><span class="font-medium">Agenda</span> </span>
                </a>
                <div class="my-auto">
                    <img alt="Icewall Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{ \Illuminate\Support\Facades\Storage::url($settings['app_logo_agenda']) }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                        Sistem Agenda Bupati
                    </div>
                    <div class="-intro-x mt-5 capitalize text-lg text-white text-opacity-70 dark:text-gray-500">Sistem Agenda untuk Efektivitas Pembuatan Agenda Daerah</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                        <img src="{{ asset('images/SIADIK.png') }}" class="mb-5 mx-auto block sm:hidden" style="height: 100px!important;">
                        Masuk <small>ke</small> Aplikasi Agenda
                    </h2>
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button type="submit" class="btn btn-danger py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Login</button>
