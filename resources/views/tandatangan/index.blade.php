...
@section('action-title')
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            <a href="{{ url('surat/tanda-tangan/create') }}" class="btn btn-primary d-none d-sm-inline-block">
                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
                Tambah Tanda Tangan
            </a>
            <a href="{{ url('surat/tanda-tangan/create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="Tambah Pengguna">
                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>
            </a>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 my-sm-0 my-1">
                                <div class="form-group">
                                    <input id="search" type="text" class="form-control" placeholder="Cari tanda tangan...">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group row">
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return new Promise(async function (resolve) {
                        var param = {
                            method: 'POST',
                            url: '{{ url('surat/tanda-tangan/bulk-delete') }}',
                            data: {
                                '_method': 'POST',
                                'ids': tableCheck
                            }
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return new Promise(async function (resolve) {
                        var param = {
                            method: 'POST',
                            url: '{{ url('surat/tanda-tangan/bulk-status') }}',
                            data: {
                                '_method': 'POST',
                                'ids': tableCheck,
                                'status': status
